                    ...
                    <div class="card card-secondary">
                        ...
                        <form id="create_form" action="{{ url('notifications') }}" role="form" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <!-- KATEGORİ BÖLÜMÜ - KATEGORİLER DOĞRUDAN PHP'DEN -->
                                <div class="row" id="type_category" style="display: none">
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <select id="category_id" name="category_id" class="form-control">
                                            ...
                                            @php
                                                // Tüm kategorileri doğrudan veritabanından çek
                                                $allCategories = \App\Models\Category::orderBy('category_name')->get();
                                            @endphp
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <select id="news_id" name="news_id" class="form-control">
                                            <option value="0">Haber Seçme (Genel Bildirim)</option>
                                        </select>
                                    </div>
                                </div>
        ...
        if (category_id) {
            $.ajax({
                ...
                success: function(response) {
                    var $news = $('#news_id');
                    $news.empty();
                    $news.append('<option value="0">Haber Seçme (Genel Bildirim)</option>');
                    
                    if (response && response.data) {
                        $.each(response.data, function(i, item) {
                            $news.append('<option value="' + item.id + '">' + item.title + '</option>');
                        });
                    }
                },
                error: function() {
