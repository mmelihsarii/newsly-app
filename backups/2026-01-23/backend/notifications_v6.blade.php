...
// Kategori değiştiğinde haberleri yükle - Panel'in mevcut fetchList fonksiyonunu kullan
$(document).on('change', '#category_id', function(e) {
    ...
    if (category_id) {
        ...
        // Panel'in mevcut get_news_by_category route'unu kullan
        var url = '{{ route('get_news_by_category') }}';
        console.log('Haber URL:', url);
        
        // fetchList fonksiyonu HTML option döndürüyor, direkt kullan
...
$(document).on('change', '#news_id', function() {
    ...
    if (title && title.indexOf('select') === -1 && title.indexOf('Önce') === -1) {
